      ...
      <div className ="container-lg">
        <div className="row g-4 justify-content-center align-items-center">
          <div className="col-md-5 text-center text-md-start">
            ...
            <a href="#pricing" className="btn border border-2 rounded-pill btn-info btn-lg">Place Vote</a>
        ...
        <div class="row my-5 g-0 align-items-center justify-content-center">
          <div class="col-8 col-lg-4 col-xl-3">
            ...
            <img src={image3} className="img-fluid" alt="img" />
                ...
                <a href="#s" class="btn btn-outline-info border border-2 rounded-pill  btn-lg mt-3">
                See Candidates
                </a>
              </div>
            </div>
